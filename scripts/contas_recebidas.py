"""
Atualiza TB_CONTASRECEBIDAS — empresa VCA.
Refatorado para ter o mesmo padrão dos demais scripts (main(), sem código solto no módulo).
"""
import requests
import base64
import math
...
# Configuração
# ----------------------------
TABLE_NAME = 'TB_CONTASRECEBIDAS'
LOG_PREFIX = 'log_contasrecebidas'
