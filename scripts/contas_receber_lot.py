"""
Atualiza TB_CONTASARECEBER_LOT — empresa LOT.
...
# Configuração
# ----------------------------
TABLE_NAME = 'TB_CONTASARECEBER_LOT'
LOG_PREFIX = 'log_contasareceber_lot'
...
def fetch_full_bills(bill_ids, chunk_size=1000):
    ...
    for idx, i in enumerate(range(0, len(bill_ids), chunk_size), start=1):
        ...
        url = (
            f'https://api.sienge.com.br/vcalotear/public/api/bulk-data/v1/income/by-bills'
